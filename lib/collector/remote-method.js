...
RemoteMethod.prototype._safeRequest = function _safeRequest(options) {
  ...
  var sender = this;
  // Check the proxy host, in case we're using SSL.
  lookup(this._config.proxy_host || options.host, function (error) {
...
RemoteMethod.prototype._request = function _request(options) {
  ...
  var request;
  if (this._config.ssl) {
    if (this._config.proxy_host) {
      requestOptions.agent = agents.https_proxy(this._config);
      request = requestOptions.agent.request(requestOptions);
    }
    else {
...
RemoteMethod.prototype._path = function _path() {
  ...
  if (!this._config.ssl && (this._config.proxy_host || this._config.proxy_port > 0)) {
